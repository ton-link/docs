...
4.2 [Jetton](#jetton)
5. [Setup node](#join)
5.1 [Registration](#registration)
5.2 [Run Node](#run)
5.2.1 [Manual](#manual)
5.2.2 [Automatic](#automatic)
6. [How oracle works?](#hiw)
6.1 [Create job](#hiw-cj)
6.2 [Job structure](#hiw-js)
6.3 [How nodes sends a response to the oracle?](#hiw-sro)
6.4 [How a smart contract gets an answer from an oracle?](#hiw-src)
6.5 [Diagram](#hiw-d)
6.6 [How do I make a request to the oracle?](#rto)
